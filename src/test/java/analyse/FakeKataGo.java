...
public class FakeKataGo extends Process {
    public FakeKataGo() throws IOException {
    ...
    private static volatile AtomicBoolean shouldWrite = new AtomicBoolean(false);
    ...
    private PipedInputStream readFromOut;
    private BufferedReader outReader;
    // send analyse output to client
    private PipedInputStream in;
    private PipedOutputStream writeToIn;
    private PrintWriter inWriter;
    // send read to use output to client
    private PipedInputStream err;
    private PipedOutputStream writeToErr;
