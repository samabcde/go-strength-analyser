...
class MoveMetricsExtractorTest {

    private MoveMetricsExtractor moveMetricsExtractor = new MoveMetricsExtractor();

    @Test
    public void Given_validInput_extractMetrics_Should_return_correctResult() {
        ...
        MoveMetrics actual = moveMetricsExtractor.extractMoveMetrics(1, info);
        MoveMetrics expected = MoveMetrics.builder()
                .moveNo(1)
    ...
    public void Given_invalidInput_Should_throw_IllegalArgumentException() {
        String info = "random";
        assertThrows(IllegalArgumentException.class, () -> moveMetricsExtractor.extractMoveMetrics(1, info));
    }
}